...
i686-elf-gcc -c kernel/memory/gdt/gdt.c -o build/gdt.o

i686-elf-ld --oformat binary -Ttext 0x1000 build/kernelasm.o build/kernelc.o build/basic_graphics.o build/memory.o build/interrupts.o build/gdt.o -o build/kernel.bin
