...
i686-elf-gcc -O0 -c kernel/basic_graphics/basic_graphics.c -o build/basic_graphics.o
i686-elf-gcc -c kernel/memory/memory.c -o build/memory.o

i686-elf-ld --oformat binary -Ttext 0x1000 build/kernelasm.o build/kernelc.o build/basic_graphics.o build/memory.o -o build/kernel.bin
